...
export const Theme1 = makeStyles((theme)=>({
    root: {
...
export const Theme2 = makeStyles((theme)=>({
    root: {
        padding:"3vh 2.5vw 5vh 2.5vw",
        backgroundColor: "#fff",
...
export const Theme4 = makeStyles((theme)=>({
    root: {
        padding:"3vh 2.5vw 5vh 2.5vw",
...
export const Theme7 = makeStyles((theme)=>({
    root: {
        padding:"3vh 2.5vw 5vh 2.5vw",
...
export const Theme8 = makeStyles((theme)=>({
    root: {
        padding:"3vh 2.5vw 5vh 2.5vw",
...
export const Theme9 = makeStyles((theme)=>({
    root: {
        padding:"3vh 2.5vw 5vh 2.5vw",
        backgroundColor: "#f9f9f9",
        backgroundPosition: "center center",
...
export const Theme10 = makeStyles((theme)=>({
    root: {
        padding:"3vh 2.5vw 5vh 2.5vw",
...
export const Theme11 = makeStyles((theme)=>({
    root: {
        padding:"3vh 2.5vw 5vh 2.5vw",
        backgroundColor: "#fff",
...
export const Theme12 = makeStyles((theme)=>({
    root: {
        padding:"3vh 2.5vw 5vh 2.5vw",
        backgroundColor: "#fff",
